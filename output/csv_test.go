...
var csvTestSet = []*resultFormatTestCase{
	...
	{
		expect:    "[!ok],404,400,www.notfound.com",
	...
	{
		expect:    fmt.Sprintf("%v[!ok]%v,404,500,abc", colorRed, colorReset),
	...
	{
		expect:    fmt.Sprintf("*[!ok]*,400,202,xyz"),
		results:   []*Result{NewResult(false, nil, "400", "202", "xyz")},
		modifiers: &ResultFormatModifiers{Markdown: true, Pretty: true},
		format:    csvFormat,
	},
	{
		expect:    fmt.Sprintf("*[!ok]*,400,300,abcdef"),
